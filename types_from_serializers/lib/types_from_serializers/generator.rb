...
module TypesFromSerializers
  ...
  private
    ...
    def serializer_interface_content(interface)
      config.namespace ? declaration_interface_definition(interface) : standard_interface_defenition(interface)
    end

    def standard_interface_defenition(interface)
      <<~TS
        //
        // DO NOT MODIFY: This file was automatically generated by TypesFromSerializers.
        #{interface.used_imports.join}
        export #{interface.as_typescript}
      TS
    end
